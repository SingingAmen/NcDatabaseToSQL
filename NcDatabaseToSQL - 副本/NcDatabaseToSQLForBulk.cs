		...
		private string GetPurchaseinToSql()
		{
			...
			try
			{
				...
				if (existResult == 0)
				{
					...
					SqlBulkCopyHelper.ImportTempTableDataIndex(PurchaseIn, "Rdrecord01");
					msg = "采购入库表插入成功";
				}
				else
				{
				...
				if (existResult == 0)
				{
					...
					SqlBulkCopyHelper.ImportTempTableDataIndex(PurchaseInLine, "Rdrecords01");
					msg = "采购入库表行插入成功";
				}
				else
				{
		...
		private string GetMaterialToSql()
		{
			...
			try
			{
				...
				if (existResult == 0)
				{
					...
					SqlBulkCopyHelper.ImportTempTableDataIndex(Material, "RdRecord11");
					msg = "材料出库表插入成功";
				}
				else
				{
				...
				if (existResult == 0)
				{
					...
					SqlBulkCopyHelper.ImportTempTableDataIndex(MaterialLine, "RdRecords11");
					msg = "材料出库表行插入成功";
				}
				else
				{
		...
		private string GetFinprodInToSql()
		{
			...
			try
			{
				...
				if (existResult == 0)
				{
					...
					SqlBulkCopyHelper.ImportTempTableDataIndex(FinprodIn, "RdRecord10");
					msg = "产成品入库表插入成功";
				}
				else
				{
				...
				if (existResult == 0)
				{
					...
					SqlBulkCopyHelper.ImportTempTableDataIndex(FinprodInLine, "RdRecords10");
					msg = "产成品入库表行插入成功";
				}
				else
				{
		...
		private string GetIAi4billToSql()
		{
			...
			try
			{
				...
				if (existResult == 0)
				{
					...
					SqlBulkCopyHelper.ImportTempTableDataIndex(IAi4bill, "RdRecord08");
					msg = "其他入库表插入成功";
				}
				else
				{
				...
				if (existResult == 0)
				{
					...
					SqlBulkCopyHelper.ImportTempTableDataIndex(IAi4billLine, "RdRecords08");
					msg = "其他入库表行插入成功";
				}
				else
				{
		...
		private string GetIAi7billToSql()
		{
			...
			try
			{
				...
				if (existResult == 0)
				{
					...
					SqlBulkCopyHelper.ImportTempTableDataIndex(IAi7bill, "RdRecord09");
					msg = "其他出库表插入成功";
				}
				else
				{
				...
				if (existResult == 0)
				{
					...
					SqlBulkCopyHelper.ImportTempTableDataIndex(IAi7billLine, "RdRecords09");
					msg = "其他出库表行插入成功";
				}
				else
				{
			...
			try
			{
				...
				if (existResult == 0)
				{
					...
					if (IcTransformH.Tables.Count > 0 && IcTransformH.Tables[0].Rows.Count > 0)
					{
						...
						SqlBulkCopyHelper.ImportTempTableDataIndex(IcTransformH, "AssemVouch");
						msg = "形态转换表插入成功";
					}
					else
					{
				...
				if (existResult == 0)
				{
					...
					if (IcTransformHLine.Tables.Count > 0 && IcTransformHLine.Tables[0].Rows.Count > 0)
					{
						...
						if (JudgeDs(IcTransformHLine))
						{
							...
							SqlBulkCopyHelper.ImportTempTableDataIndex(IcTransformHLine, "AssemVouchs");
							msg = "形态转换表行插入成功";
						}
						else
						{
		...
		private string GetIcWhstransHToSql()
		{
			...
			try
			{
				...
				if (existResult == 0)
				{
					...
					SqlBulkCopyHelper.ImportTempTableDataIndex(IcWhstransH, "TransVouch");
				...
				if (existResult == 0)
				{
					...
					SqlBulkCopyHelper.ImportTempTableDataIndex(IcWhstransHLine, "TransVouchs");
					msg = "转库单表行插入成功";
				}
				else
				{
		...
		private string GetSaleOutToSql()
		{
			...
			try
			{
				...
				if (existResult == 0)
				{
					...
					SqlBulkCopyHelper.ImportTempTableDataIndex(SaleOut, "DispatchList");
					msg = "销售出库表插入成功";
				}
				else
				{
				...
				if (existResult == 0)
				{
					...
					SqlBulkCopyHelper.ImportTempTableDataIndex(SaleOutLine, "DispatchLists");
					msg = "销售出库表行插入成功";
				}
				else
				{
		...
		private string GetPurchaseInvoicesToSql()
		{
			...
			try
			{
				...
				if (existResult == 0)
				{
					...
					SqlBulkCopyHelper.ImportTempTableDataIndex(Invoices, "PurBillVouch");
					msg = "采购发票表插入成功";
				}
				else
				{
				...
				if (existResult == 0)
				{
					...
					SqlBulkCopyHelper.ImportTempTableDataIndex(InvoiceLine, "PurBillVouchs");
					msg = "采购发票表行插入成功";
				}
				else
				{
		...
		private string GetSoSaleinvoiceToSql()
		{
			...
			try
			{
				...
				if (existResult == 0)
				{
					...
					SqlBulkCopyHelper.ImportTempTableDataIndex(Saleinvoice, "SaleBillVouch");
					msg = "销售发票表插入成功";
				}
				else
				{
				...
				if (existResult == 0)
				{
					...
					SqlBulkCopyHelper.ImportTempTableDataIndex(SaleinvoiceLine, "SaleBillVouchs");
					msg = "销售发票表行插入成功";
				}
				else
				{
