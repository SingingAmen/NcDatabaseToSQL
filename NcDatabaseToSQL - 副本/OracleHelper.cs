...
namespace ERP8.Common
{
    ...
    {
        private static string connectionString = ConfigurationManager.ConnectionStrings["NCConn"].ToString();
        ...
        public static string ExecuteNonQuery(String connectionString, string procName, OracleParameter[] parms, string rtnColumnName)
        {
            using (OracleConnection connection = new OracleConnection(connectionString))
            {
                connection.Open();
        ...
        public static string ExecuteNonQuery(string procName, OracleParameter[] parms, string rtnColumnName)
        {
            using (OracleConnection connection = new OracleConnection(connectionString))
            {
                connection.Open();
        ...
        public static DataSet ExecuteDataset(string commandText)
        {
            ...
            {
                OracleDataAdapter da = new OracleDataAdapter(commandText, conn);
